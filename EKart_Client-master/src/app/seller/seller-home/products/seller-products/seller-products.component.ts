...
export class SellerProductsComponent implements OnInit {
  ...
  addtoDealFlag: Boolean = false;

  constructor(private sellerProductsService: SellerProductsService, private sellerSharedService : SellerSharedService) { }
  ...
  addToDeal(product: Product) {
    this.displayProducts = false;
    this.addtoDealFlag = true;
    this.sellerSharedService.buildModelDataObject(product, this);
  }

  // Sourav
  clearFlags() {
    this.displayProducts = true;
    this.addtoDealFlag = false;
    this.sellerSharedService.buildModelDataObject(undefined, this);
  }
}
